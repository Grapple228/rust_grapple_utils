...
const ENCODING: data_encoding::Encoding = data_encoding::BASE64_NOPAD;

/// Encodes data into a Base64 string without padding.
///
/// # Parameters
...
pub fn decode_to_string(b64: &str) -> Result<String> {
    base_x::decode_to_string(b64, ENCODING)
}
